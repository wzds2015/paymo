...
function setup_testing_input_output {
  TEST_OUTPUT_PATH=${GRADER_ROOT}/${OUTPUT_DIR}
...
function compare_outputs {
  PROJECT_ANSWER_PATH1=${GRADER_ROOT}/${OUTPUT_DIR}/paymo_output/output1.txt
  PROJECT_ANSWER_PATH2=${GRADER_ROOT}/${OUTPUT_DIR}/paymo_output/output2.txt
  PROJECT_ANSWER_PATH3=${GRADER_ROOT}/${OUTPUT_DIR}/paymo_output/output3.txt
